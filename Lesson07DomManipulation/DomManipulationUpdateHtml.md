# Written Guide: Updating HTML with DOM Manipulation
DOM Manipulation can get input from the user, but it can also interact with the HTML in other ways! After reading through this guide, you should be able to **use JavaScript** to:
