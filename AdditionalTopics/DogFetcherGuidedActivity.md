...
By the end of the activity, the **script.js** file should look something like this:
...
## Next Steps
[Click here to see how you can make more updates to the Dog Fetcher site.](DogFetcherUpdates.md)
