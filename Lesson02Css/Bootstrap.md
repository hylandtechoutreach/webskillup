# Guided Activity: Bootstrap Magazine Website
Create a simple website for a magazine called _Dirigible Digest_. The website will contain articles related to dirigibles, and will be formatted using [Bootstrap](https://getbootstrap.com/docs/5.3/getting-started/introduction/). A dirigible balloon, or airship, is a type of aerostat or lighter-than-air aircraft that can navigate through the air under its own power. For more information about dirigibles, refer to [this article](https://en.wikipedia.org/wiki/Airship).
